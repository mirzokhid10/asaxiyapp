        ...
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                ...
                <div class="dropdown dropleft d-inline">
                    ...
                    <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 28px, 0px); top: 0px; left: 0px; will-change: transform;">
                       ...
                       <a class="dropdown-item has-icon" href="' . route('admin.products.values.index', ['productId' => $query->id]) . '"><i class="far fa-file"></i> Attributes </a>


                    </div>
                </div>';

                return "<div class='d-flex align-items-center justify-center gap-2'>" . $editBtn . $deleteBtn . $moreBtn . "</div>";
            })
            ...
            ->editColumn('product_type', function ($query) {
                switch ($query->product_type) {
                    case 'super_price':
                        return '<span class="badge badge-danger">Super Price</span>';
                    case 'top':
                        return '<span class="badge badge-dark">Top</span>';
                    case 'discount':
                        return '<span class="badge badge-warning">Discount</span>';
                    case 'new':
