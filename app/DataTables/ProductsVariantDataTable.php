...
class ProductsVariantDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<ProductsVariant> $query Results from query() method.
     */
     ...
     *
     * @return QueryBuilder<ProductsVariant>
     */
    public function query(ProductsVariant $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('productsvariant-table')
