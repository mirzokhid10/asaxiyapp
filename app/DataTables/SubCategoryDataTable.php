...
class SubCategoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                ...
                $deleteBtn = '<button type="submit" href="javascript:void(0);" class="btn btn-danger ml-2 delete-sub-category" data-id="' . $query->id . '" style="background-color: #fc544b !important;">
    ...
    {
        return $model->newQuery()->with('category')->orderBy('id', 'asc'); // eager load category name
    }
