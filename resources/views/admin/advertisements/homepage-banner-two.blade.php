            ...
            <form action="{{ route('admin.homepage-banner-section-two') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <label class="custom-switch mt-2">
                        ...
                        <input type="checkbox" name="status" value="1" class="custom-switch-input"
                            {{ old('status', $homepage_section_banner_two->status ?? 0) ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control col-12 col-md-9" name="banner_style"
                        value="{{ old('banner_style', $homepage_section_banner_two->banner_style ?? '') }}">
                    @error('banner_style')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control col-12 col-md-9" name="banner_url"
                        value="{{ old('banner_url', $homepage_section_banner_two->banner_url ?? '') }}">
                    @error('banner_url')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control col-12 col-md-9" name="banner_text"
                        value="{{ old('banner_text', $homepage_section_banner_two->banner_text ?? '') }}">
                    @error('banner_text')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row m-0 d-flex align-items-center">
                        ...
                        @if (!empty($homepage_section_banner_two?->banner_app_image))
                            <small
                                class="col-md-3 row d-flex align-items-center mx-auto gap-5 justify-content-around"><span>Current:</span>
                                <img class="" src="{{ asset($homepage_section_banner_two->banner_app_image) }}"
                                    width="120"></small>
                        @endif
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row m-0 d-flex align-items-center">
                        ...
                        @if (!empty($homepage_section_banner_two?->banner_qr))
                            <small
                                class="col-md-3 row d-flex align-items-center mx-auto gap-5 justify-content-around"><span>Current:</span>
                                <img class="" src="{{ asset($homepage_section_banner_two->banner_qr) }}"
                                    width="120"></small>
                        @endif
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row m-0 d-flex align-items-center">
                        ...
                        @if (!empty($homepage_section_banner_two?->banner_appstore))
                            <small
                                class="col-md-3 row d-flex align-items-center mx-auto gap-5 justify-content-around"><span>Current:</span>
                                <img src="{{ asset($homepage_section_banner_two->banner_appstore) }}"
                                    width="120"></small>
                        @endif
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row m-0 d-flex align-items-center">
                        ...
                        @if (!empty($homepage_section_banner_two?->banner_googleplay))
                            <small
                                class="col-md-3 row d-flex align-items-center mx-auto gap-5 justify-content-around"><span>Current:</span>
                                <img src="{{ asset($homepage_section_banner_two->banner_googleplay) }}"
                                    width="120"></small>
                        @endif
                    </div>
